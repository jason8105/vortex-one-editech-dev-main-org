...
public class SpoofUtil {
    // Explicitly expanded with Play Games, GMS, and Vending for seamless authentication
    public static List<String> KNOWN_GOOGLE_PACKAGES = Arrays.asList(
    ...
    public static String fakeGoogleSignatureData =
    ...
    private static SigningInfo createSigningInfo(Signature sig, PublicKey publicKey) {
        ...
        try {
            ...
            Log.w(TAG, "failed to create signingInfo", e);
        }
    ...
    public static void killPM() {
        try {
            ...
            Log.e(TAG, "Failed to initialize killPM hooks", e);
        }
    }
}
