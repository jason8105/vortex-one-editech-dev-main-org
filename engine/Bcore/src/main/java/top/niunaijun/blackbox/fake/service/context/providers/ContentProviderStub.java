...
public class ContentProviderStub extends ClassInvocationStub implements BContentProvider {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        // For call() method, String args are method names like "GET_global", NOT
        // package names
        // UNLESS it is the Settings provider, where arg0 CAN be the package name.
        // We safely check if arg0 matches the Guest Package.
        if ("call".equals(methodName)) {
            if (args != null && args.length > 0) {
                ...
                if (arg0 instanceof String) {
                    ...
                    // Get current Guest Package dynamically
                    ...
                    // Safe replacement: Only if it EXACTLY matches our Guest Package
                    if (guestPkg != null && strArg0.equals(guestPkg)) {
                        Slog.e(TAG, "Safe replacement in call(): " + strArg0 + " -> " + BlackBoxCore.getHostPkg());
                        args[0] = BlackBoxCore.getHostPkg();
                    } else {
                        if (strArg0.contains(".")) {
                            Slog.e(TAG, "Missed replacement in call(): " + strArg0 + " vs Guest: "
                                    + (guestPkg != null ? guestPkg : "null"));
                        }
                    }
                }
            }
            ...
            // For other methods like query/insert/update/delete, fix both package names and
            // AttributionSource
            if (args != null && args.length > 0) {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        java.lang.reflect.Method setUidMethod = attributionSourceClass.getDeclaredMethod("setUid",
                                int.class);
